...
TheCompose fileprovides a way to document and configure
...
and destroy isolated testing environments for your test suite. By defining the full environment in aCompose file, you can create and destroy these environments in just a few commands:
...
For details on using production-oriented features, seeCompose in production.
